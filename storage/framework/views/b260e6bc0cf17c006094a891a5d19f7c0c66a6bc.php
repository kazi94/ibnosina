    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('patient.index')); ?>"><i class="fa fa-list-alt"></i> Mes Patients</a></li>
        ...
        <section class="content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="POST"
                action="<?php echo e(route('patient.create.step.one.post')); ?>" autocomplete="off">
...
<?php echo $__env->make('layouts.model-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\user\patient\create_rapide\step_one.blade.php ENDPATH**/ ?>