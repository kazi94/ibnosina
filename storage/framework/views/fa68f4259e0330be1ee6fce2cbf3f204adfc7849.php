<?php $__env->startSection('script_css'); ?>
 <link rel="stylesheet" href="<?php echo e(asset('/plugins/bootstrap-tagsinput.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('/plugins/typeaheadjs.css')); ?>">
          ...
          <div class="box box-solid">
            ...
            <div class="box-header">
                ...
                <span class="headerLine"></span>
                 ...
                 <div class="row">
                   <div class="col-sm-12 ">
                    <?php if($protocoles->isEmpty()): ?>
                        <div class="isa_error" style="text-align: center; width: 80%;position: relative; left: 10%">
                         <h4><i class="fa fa-times-circle"></i> Aucun protocole de chimiothérapie trouvé veuillez <a href="<?php echo e((route('protocole.index'))); ?>">ajouter un</a></h4>
                      </div>
                      <br>
                      <?php elseif($col->isEmpty() && $protocoles->isNotEmpty()): ?>
                    ...
                    <div class="col-sm-12 ">
                        <div class="box-body table-responsive no-padding">
                            <table id="t_protocole" class="table table-responsive text-center dataTable table table-hover" aria-describedby="t_protocole">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $col; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cle => $valeur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $m = $loop->index; ?>
                                     <tr>
                                        <th><?php echo e($cle); ?></th>
                                        <td id="nom_path"><?php echo e(DB::table('pathologies')->where('id',$cle)->pluck('pathologie')->first()); ?></td>

                                        <td>
                                          <?php $__currentLoopData = $valeur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <a class="lol" href="<?php echo e(route('detailProtocole',$p->protocole_id)); ?>">
                                            <?php echo e(DB::table('protocole')->where('id',$p->protocole_id)->pluck('nom')->first()); ?>
                                        ...
                                        <td>
                                          ...
                                          <?php $__currentLoopData = $col2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valeur2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <?php if($loop->index == $m ): ?>
                                            <?php $__currentLoopData = $valeur2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <d class="lol2" style="cursor: pointer;">
                                                <?php echo e($v->stade_chimios_id); ?>
                                        ...
                                        <td>        
                                          ...
                                          <span class="glyphicon glyphicon-edit" style="cursor: pointer" onclick="editData(this,'<?php echo e($cle); ?>')"></span>
                                      
                                    
                                            <span class="glyphicon glyphicon-trash" style="color: red; cursor: pointer" onclick="deleteData('<?php echo e($cle); ?>')"></span>
        ...
        <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="<?php echo e(route('addMaladie')); ?>" method="post" id="addMaladie">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control select2" id="bla" name ="protocoles[]" multiple="multiple"  placeholder="dsdsd" style="width: 100%;"  required>
                    <?php $__currentLoopData = $protocoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade" id="modal-edit">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="<?php echo e(route('addMaladie')); ?>" method="post" id="editMaladie">
                            <?php echo e(csrf_field()); ?>
...
<script src="<?php echo e(asset('plugins/bootstrap-tagsinput.js')); ?>"></script>

<script src="<?php echo e(asset('plugins/typeahead.bundle.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\chimio\listMaladie.blade.php ENDPATH**/ ?>