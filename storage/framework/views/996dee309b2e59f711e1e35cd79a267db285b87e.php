...
<?php echo $__env->make('includes.modals.prescription-examen' , compact('patient'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- Modal analyse biologique -->
...
<div class="modal fade" id="modal_demande_examen" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('bilan.store')); ?>" enctype="multipart/form-data"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row col-sm-offset-1">
                    <input type="text" id="id_pat" value="<?php echo e($patient->id); ?>" hidden>
                    <?php
                    ...
                    <?php $__currentLoopData = $dashboards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dashboard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-12">
                            <label><input type="radio" name="dash" value="<?php echo e($dashboard->nom); ?>" checked=false>
                                <?php echo e($dashboard->nom); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\anapharm\resources\views/user/patient/modals/examen.blade.php ENDPATH**/ ?>