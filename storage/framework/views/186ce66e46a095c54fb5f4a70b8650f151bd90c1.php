...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('/lugins/bootstrap/dist/css/bootstrap.min.css')); ?>">
    ...
    <div class="wrapper">
      ...
      <section class="invoice">
        ...
        <h2 class="page-header"></h2>
            <form class="form-group" role="form" method="POST" action="<?php echo e(route('prescription.update',$lignes[0]['patient_id'])); ?>">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" style="">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?php echo e(route('patient.print_conciliation' , $lignes[0]['patient_id'])); ?>" method="POST">
...
</html><?php /**PATH C:\laragon\www\anapharm\resources\views\user\patient\conciliation.blade.php ENDPATH**/ ?>