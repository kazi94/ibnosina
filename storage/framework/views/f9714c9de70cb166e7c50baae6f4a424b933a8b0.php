  ...
  font-size: 1.6rem !important;
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
           <a type="submit"class="btn btn btn-primary" href="<?php echo e((route('protocole.index'))); ?>">Ajouter un protocole</a>
          ...
          <div class="box box-solid">
            <div class="box-header">
                ...
                <span class="headerLine"></span>
                 ...
                 <div class="row">
                    <div class="col-sm-12 ">
                      <?php if($protocole->isEmpty()): ?>
                      
                        <div class="isa_info" style="width: 80%; text-align: center;position: relative; left: 10%">
                          <h4><i class="fa fa-info-circle"></i> Aucun protocole de chimiothérapie trouvé veuillez <a style="color:red" href="<?php echo e((route('protocole.index'))); ?>">ajouter un</a></h4>
                      ...
                      <br>
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="t_protocole" class="table table-responsive text-center dataTable table table-hover" aria-describedby="t_protocole">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $protocole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <tr>
                                        <td><strong><?php echo e($pro->id); ?></strong></td>
                                        <td><?php echo e($pro->nom); ?></td>
                                        <td><?php echo e(strtoupper(Auth::user()->name)); ?> <?php echo e(Auth::user()->prenom); ?></td>
                                        <td><?php echo e($pro->created_at); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('detailProtocole',$pro->id)); ?>"style="color:black;">
                                                <span class="glyphicon glyphicon-eye-open"></span>
                                            </a>                 
                                         <span class="glyphicon glyphicon-edit" style="cursor: pointer" onclick="editData()"></span>
                                      
                                    
                                            <span class="glyphicon glyphicon-trash" style="color: red; cursor: pointer" onclick="deleteLigne(<?php echo e($pro->id); ?>)"></span>
                                        </td>
                                     </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\chimio\listProtocole.blade.php ENDPATH**/ ?>