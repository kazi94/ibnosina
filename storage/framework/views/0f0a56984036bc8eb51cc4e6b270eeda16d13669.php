         ...
         <div class="masthead inline-header right widgets shadow-decoration small-mobile-menu-icon dt-parent-menu-clickable show-device-logo show-mobile-logo"
             ...
             <header class="header-bar">
                 <div class="branding">
                     ...
                     <a class="" href="https://www.medicaments.hic-sante.com/"><img class=" preload-me"
                             src="<?php echo e(asset('bddm/images/logo.png')); ?>" srcset="<?php echo e(asset('bddm/images/logo.png')); ?>"
                             width="160" height="70" sizes="160px" alt="hic-sante.com" /><img
                             class="mobile-logo preload-me" src="<?php echo e(asset('bddm/images/logo.png')); ?>"
                             srcset="<?php echo e(asset('bddm/images/logo.png')); ?>" width="160" height="70" sizes="160px"
                             alt="HIC MEDIC" /></a>
                 </div>
                 <ul id="primary-menu"
             ...
             <nav class="d-md-none navbar navbar-dark navbar-expand-lg rounded shadow-sm">
                 <a class="" href="https:\\www.medicaments.hic-sante.com">
                     <img src="<?php echo e(asset('bddm/images/logo.png')); ?>" height="52px"
                 ...
                 <div class="collapse navbar-collapse mt-1" style="background: orange" id="navbarText">
                     <ul class="navbar-nav mr-auto ml-1 text-uppercase text-center">
                         <li class="nav-item active">
                             <a class="nav-link" href="<?php echo e(route('medicaments.noms-commerciale')); ?>"> <i
                                     class="fa fa-pills"> </i> Médicaments </a>
                         </li>
                         <li class="nav-item active">
                             <a class="nav-link" href="<?php echo e(route('medicaments.substances')); ?>"> <i class="fa fa-tablets">
                                 </i> Substances Actives</a>
                         </li>
                         
                         <li class="nav-item active">
                             <a class="nav-link" href="<?php echo e(route('medicaments.indications')); ?>"> <i
...
<?php /**PATH C:\laragon\www\anapharm\resources\views\bddm\layouts\navbar.blade.php ENDPATH**/ ?>