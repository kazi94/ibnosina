                ...
                <div class="col-xs-12">
                    <div class="box box-info" id="prescription_box">
                        ...
                        <div class="box-body">
                            ...
                            <input type="hidden" name="presc" value="<?php echo e($presc); ?>">
                            <input type="hidden" name="cons_id" value="<?php echo e(session('consultation_id')); ?>" />
                        ...
                        <div class="box-footer">
                            ...
                            <?php if(session()->has('type') && session('type') == 'consultation'): ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('patient.create.step.three', ['id' => session('hospi_id')])); ?>">
                                    <button type="button" class="btn btn-default pull-left"><i class="fa fa-arrow-left"></i>
                                        Précédent </button>
                                </a>
                            <?php endif; ?>
    ...
    <script>
        $(function() {
            ...
            function savePrescription() {
                ...
                const url = "<?php echo e(route('patient.create.step.four.post')); ?>";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        window.location.href = "<?php echo e(route('patient.create.step.five')); ?>"
                    },
...
<?php echo $__env->make('layouts.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\user\patient\create_rapide\step_four.blade.php ENDPATH**/ ?>