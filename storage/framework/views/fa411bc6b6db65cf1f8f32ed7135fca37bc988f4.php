...
<div class="tab-pane <?php echo e(session('tab') == 'tab_4' ? 'active in' : ''); ?>" id="tab_4">
    ...
    <div class="clearfix">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('traitements_chronique.create', Auth::user())): ?>
            ...
            <?php endif; ?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('traitements_chronique.export', Auth::user())): ?>
            <a href="/export/trait_c/<?php echo e($patient->id); ?>"><button type="button" class="btn btn-success pull-right"><i
                ...
                <div class="col-sm-12">
                    <div class="box-body table-responsive">
                        <table id="example4" class=" table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $patient->traitements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ligne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            ...
                                            <?php echo $ligne->dose_midi != 0 ? $ligne->dose_midi . ' à <b
                                                class="text-green">Midi</b>, ' : ''; ?>

                                            <?php echo $ligne->dose_soir != 0 ? $ligne->dose_soir . ' le <b
                                                class="text-yellow">Soir</b>, ' : ''; ?>

                                            <?php echo $ligne->dose_avant_coucher != 0 ? $ligne->dose_avant_coucher . ' <b
                                            ...
                                            <?php if(!$patient->readonly): ?>
                                                <td>
                                                    <a href="javascript:void(0)" class="deleteRow"
                                                        data-url="<?php echo e(route('traitement_chronique.destroy', $ligne->traitementchronique_id)); ?>"><span
    ...
    <?php if(count($patient->tmp_traitements) > 0): ?>
        <div class="box box-widget">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="example7" class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $patient->tmp_traitements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmp_trai_ligne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th>
                                            <?php
                                                $resultats = DB::table('cosac_compo_subact')
                                        ...
                                        <th> <?php echo e($tmp_trai_ligne->voie); ?> </th>
                                        <td> <?php echo e($tmp_trai_ligne->dose_matin); ?><?php echo e($tmp_trai_ligne->repas_matin); ?>

                                        </td>
                                        <td> <?php echo e($tmp_trai_ligne->dose_midi); ?><?php echo e($tmp_trai_ligne->repas_midi); ?>

                                        </td>
                                        <td> <?php echo e($tmp_trai_ligne->dose_soir); ?><?php echo e($tmp_trai_ligne->repas_soir); ?>

                                        </td>
                                        <td> <?php echo e($tmp_trai_ligne->dose_avant_coucher); ?> </td>
                                        <td> <?php echo e($tmp_trai_ligne->unite); ?> </td>
                                        <td>Dr.<?php echo e($tmp_trai_ligne->medecin_externe); ?> </td>
                                        
                                        <td> <?php echo e($tmp_trai_ligne->date_etats); ?> </td>
                                        <td>
                                        <?php if($tmp_trai_ligne->status_hopital == '1'): ?> H <?php else: ?> V
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <a><button id="btn_ann_chron" class="btn btn-default" data-toggle="modal"
                                                    data-target="#modal_annotation" data-type="traitement"
                                                    data-id="<?php echo e($tmp_trai_ligne->id); ?>"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('patients.valide', $patient)): ?>
                                            ...
                                            <td>
                                                <a href="" class="deleteRow"
                                                    data-url="<?php echo e(route('traitement.confirm', $tmp_trai_ligne->id)); ?>"
                                            ...
                                            <td>
                                                <a href="" class="deleteRow"
                                                    data-url="<?php echo e(route('traitement.destroy_tmp', $tmp_trai_ligne->id)); ?>"
...
<?php /**PATH C:\laragon\www\anapharm\resources\views\user\patient\tabs\traitement.blade.php ENDPATH**/ ?>