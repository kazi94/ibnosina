...
<body>
    <div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>Erreur</h2>
            <p>Ruh-roh... Une erreur est survenue, SVP! Veuillez signaler cette erreur à notre équipe technique.
            </p>
            <p> Nous allons répondre à votre signalement dans les meilleurs délais</p>
            <div><a href="/bugs_report" class="btn btn-primary">Je signale l'erreur</a></div>
        </div>
...
<?php /**PATH C:\laragon\www\anapharm\resources\views\errors\500.blade.php ENDPATH**/ ?>