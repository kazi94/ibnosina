...
<div class="modal fade in" id="modal_phyto">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo e(route('phytotherapie.store')); ?>" enctype="multipart/form-data" class="form-horizontal">
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-9">
							...
							<select name="used_on" class="form-control select2">
								...
								<option value="<?php echo e($pathologie->id); ?>"><?php echo e($pathologie->pathologie); ?></option>
...
</div><?php /**PATH C:\laragon\www\anapharm\resources\views/user/patient/modals/phytotherapie.blade.php ENDPATH**/ ?>