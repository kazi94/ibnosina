                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered text-center table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $prescriptionsServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="text-bold"><?php echo e($loop->index + 1); ?></td>
                                                    <td><?php echo e($type->name); ?></td>
                                                    <td><?php echo e($type->service); ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <form style="display: none;" method="POST"
                                                            action="<?php echo e(route('prescription-service.destroy', $type->id)); ?>"
                                                            id="delete-form-<?php echo e($type->id); ?>">
                                                        ...
                                                        <a href="#"
                                                            onclick="
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            { 
                                                                                                                                                                                                                                                                                                event.preventDefault();document.getElementById('delete-form-<?php echo e($type->id); ?>').submit();	
                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                            ">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered text-center table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $prescriptionsExamens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="text-bold"><?php echo e($loop->index + 1); ?></td>
                                                    <td><?php echo e($type->name); ?></td>
                                                    <td><?php echo e($type->service); ?></td>
                                                    ...
                                                    <td>
                                                        <form style="display: none;" method="POST"
                                                            action="<?php echo e(route('prescription-examen.destroy', $type->id)); ?>"
                                                            id="delete-form-<?php echo e($type->id); ?>">
                                                            <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_demande_examen" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('prescription-examen.store')); ?>" enctype="multipart/form-data"
    ...
    <script>
        ...
        function savePrescriptionType() {
            ...
            if (name == "") {
                ...
                formData.append(
                    '_method',
                    $modalPrescSelector.find("input[name='method']").val() == "PUT" ? 'PATCH' : ''
                );
                $.ajax({
                    type: 'POST',
                    processData: false,
...
<?php echo $__env->make('layouts.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\admin\prescription-type\show.blade.php ENDPATH**/ ?>