...
<div class="modal fade in" id="modal_annotation">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('addAnnotation')); ?>" class="form-horizontal" method="post"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="hidden" name="domaine" value="<?php echo e(Auth::user()->specialite); ?>">
                            <?php echo e(Auth::user()->specialite); ?>
...
<?php /**PATH C:\laragon\www\anapharm\resources\views/user/patient/modals/annotation.blade.php ENDPATH**/ ?>