                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="element" style="">
                            <form method="POST" action="<?php echo e(route('reglee.update', $reglee->id)); ?>"
                                ...
                                <div class="form-group" id="textSelection">
                                    ...
                                    <textarea class="form-control" rows="5" onkeypress="interdireEcriture()"
                                        require><?php echo e($reglee->si); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="commentaire" id="exampleFormControlTextarea1"
                                        rows="3"><?php echo e($reglee->commentaire); ?></textarea>
                                </div>
...
<?php echo $__env->make('layouts.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\anapharm\resources\views\admin\regle\edit1.blade.php ENDPATH**/ ?>