...
<div class="modal fade" id="modal_hospitalisation">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('hospitalisation.store')); ?>" enctype="multipart/form-data"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="owned_by" id="owned_by">
                                            ...
                                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($r->id); ?>"><?php echo e($r->name); ?>

                                                    <?php echo e($r->prenom); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade in" id="modal_detail_impression">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('hospitalisation.shows')); ?>" class="up_impression" method="post"
...
<?php /**PATH C:\laragon\www\anapharm\resources\views/user/patient/modals/hospitalisation.blade.php ENDPATH**/ ?>