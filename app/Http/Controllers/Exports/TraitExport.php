...
use Excel;
class TraitExport extends Controller
{
    public function export_bilan ($patient_id) {
        ...
        header("Content-Disposition: attachment;filename='traitementc_chronique_".$patient->nom."_".$patient->prenom."_". Date("Y-m-d H:i:s") .".xls'");
