...
class PhytotherapiePolicy
{
    ...
    {
            return  self::getPermission($user , 'lister_details_phyto');
    }
    public function view(User $user)
    {
            return  self::getPermission($user , 'lister_phyto');
    }
    /**
    ...
    {
          return  self::getPermission($user , 'ajouter_phyto');
    }
    ...
    {
        return  self::getPermission($user , 'modifier_phyto');
    }
    ...
    {
        return  self::getPermission($user , 'supprimer_phyto');
    }
    public function export(User $user)
    {
        return  self::getPermission($user , 'exporter_phyto');
    }
