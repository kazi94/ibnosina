...
@endsection
@section('script')
    <script src="{{ asset('plugins/scheduler/codebase/dhtmlxscheduler.js?v=5.2.1') }}" type="text/javascript"
        charset="utf-8"></script>
    <script src="{{ asset('plugins/scheduler/codebase/ext/dhtmlxscheduler_agenda_view.js?v=5.2.1') }}"
        type="text/javascript" charset="utf-8"></script>
    <script src="{{ asset('plugins/scheduler/codebase/ext/dhtmlxscheduler_quick_info.js?v=5.2.1') }}"
        type="text/javascript" charset="utf-8"></script>
    <script src="{{ asset('plugins/scheduler/codebase/ext/dhtmlxscheduler_readonly.js?v=5.2.1') }}" type="text/javascript"
        charset="utf-8"></script>
    <script src="{{ asset('plugins/scheduler/codebase/sources/locale/locale_fr.js') }}" type="text/javascript"
        charset="utf-8"></script>
