...
@section('title')
    Mon Service
@endsection
<link rel="stylesheet" href="{{ asset('plugins/morris.css') }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-blue">
                    ...
                    <a href="{{ route('patient.index') }}" class="small-box-footer">Plus d'info <i
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="{{ route('patient.archives') }}" class="small-box-footer">Plus d'info <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
