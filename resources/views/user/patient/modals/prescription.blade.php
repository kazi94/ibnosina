                    ...
                    @if (isset($pr_risque))
                        ...
                        @foreach ($ra as $val)
                            <tr>
                                ...
                                <td>
                                    @if ($val->dose_matin) <input type="checkbox"
                                            checked> {{ $val->repas_matin }} @endif
                                </td>
                                <td>
                                    @if ($val->dose_midi) <input type="checkbox"
                                            checked> {{ $val->repas_midi }} @endif
                                </td>
                                <td>
                                    @if ($val->dose_soir)<input type="checkbox"
                                            checked> {{ $val->repas_soir }} @endif
                                </td>
                                <td>
                                    @if ($val->dose_avant_coucher)<input
                                            type="checkbox" checked> @endif
                                </td>
