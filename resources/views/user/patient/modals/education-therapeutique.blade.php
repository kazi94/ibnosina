...
<div class="modal fade" id="modal_entretien">
	<div class="modal-dialog  modal-md ">
		<div class="modal-content">
			...
			<form method="POST" action="{{ route('education_therapeutique.store') }}" enctype="multipart/form-data" class="form-horizontal" id="formEducation">
				{{ csrf_field() }}
