                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body" id="modalPrescriptionVille">
                            <div class="bg-success col-xs-6 form-horizontal pt-2">
                                ...
                                <form id="addLineTraitement" action="{{ route('patient.create.step.five.post') }}">
                                    {{ csrf_field() }}
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{ route('patient.create.step.four', ['id' => session('presc_id')]) }}">
...
@section('script')
    ...
    <script src="{{ asset('js/user/patient/gestion_traitement_auto.js') }}"></script>
    <script>
        $(function() {
