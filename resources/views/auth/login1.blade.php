...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('plugins/iCheck/square/all.css') }}">
...
">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{-- <a href="#">Vous avez oublié vos identifiants?</a><br> --}}
    ...
    <!-- jQuery 3 -->
    <script src="{{ asset('plugins/jquery/js/dist/jquery.min.js') }}"></script>
