                    ...
                    <div class="box-body">
                        <div role="tabpanel">
                            ...
                            <div class="tab-content">
                             ...
                             document.getElementById('delete-form-{{ $reglee->id }}').submit();										}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn DetailsEdu"
                                                                    data-id="{{ $education->id }}">Details</button>
                            ...
                            " style="color: inherit; "><span class="glyphicon glyphicon-trash"></span>
                             ...
                             if (confirm('voulez vous supprimer cette ligne ?')) {
                             event.preventDefault();
                             document.getElementById('delete-form-{{ $suivi->id }}').submit();										}
                            " style="color: inherit; "><span class="glyphicon glyphicon-trash"></span>
                                                                </a>
                                                            </td>
...
@section('script')
    ...
    <script src="{{ asset('/js/admin/regle/detailsRegleEdu.js') }}"></script>
    <style>
        .panel-group .panel {
            border-radius: 0;
            box-shadow: none;
