        ...
        <div class="row">
            <div class="col-md-8 col-xs-12 col-md-offset-2">
                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <div class="box-body">
                        <form method="POST" action="{{ route('pharmaco.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('/js/admin/pharmacovigilance/medicaments.js') }}"></script>
    <script>
