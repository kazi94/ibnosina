 ...
 <div class="row">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="row">
                    <div class="col-sm-12 ">
                      @if(!empty($erreurformule))
                          <div class="isa_error" style="text-align: center; width: 80%;position: relative; left: 10%">
                         <h4><i class="fa fa-times-circle"></i> {{$erreurformule}}</h4>
                          </div>
                          <br>
                      @else
          <form action="{{ route('addTraitement') }}" method="post">
                            {{ csrf_field() }}
            ...
            <div class="box-header">
                <div class="sectiontitle">
                 ...
                 {{$patient->age($patient->date_naissance)}} </h4>
                  <h5>Numéro D'identification: <strong> {{$patient->id}}  </strong>,
                 Numéro du Dossier: <strong> {{$patient->num_dossier}}   </strong></h5>
                </div><br>
            <div class="col-sm-12">
              <div class="lol">
 ...
 <div class="col-sm-12">
        ...
        <div class="form-lol front">
          ...
          <div class="col-sm-12">
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control"  style="text-align: center" value="{{date('Y-m-d')}}" disabled >
              <input type="hidden" name="dater" value="{{date('Y-m-d')}}"><br>
          ...
          <label class="control-label">Nom Prénom du Médecin</label>
              <input type="text" class="form-control" style="text-align: center" disabled value="Dr {{strtoupper(Auth::user()->name)}} {{Auth::user()->prenom}}" name="">
        </div>
      </div>
    </div>
    <div class="col-sm-4">
   ...
   <h3 class="form-label"><strong> Détail </strong></h3><br>
    ...
    <div class="form-group" style="text-align: center">
       ...
       <div class="col-sm-7">
           <input type="number" name="taille" id="taillee" class="form form-control"  placeholder="Taille" style="text-align: center" value="{{$patient->taille}}" required onchange="calculeSC()"><br>
       </div>
     </div>
    ...
    <div class="form-group" style="text-align: center">
       ...
       <div class="col-sm-7">
           <input type="number" step="0.01" name="poids" id="poidss" class="form form-control"  placeholder="Poids" style="text-align: center"  value="{{$patient->poids}}" required onchange="calculeSC()"><br>
       </div>
    </div>
    <div class="form-group" style="text-align: center">
                ...
                success: function( data , status , code ) {
                  ...
                  if (data == 0) {
                    Swal.fire({
                        ...
                        footer: '<a href="{{(route('listMaladie.index'))}}">Attacher des protocole a la maladie</a>'
                      })
