...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="row">
                <div class="col-sm-12 ">
                    <form action="{{ route('protocole.store') }}" method="POST" id="formAddProtocole">
                        {{ csrf_field() }}
                        <input type="submit" style="display: none; float: left" class="btn btn-primary" id="submitForm"
                            value="Valider et ajouter le protocole">
                        <a type="button" class="btn  btn-default" href="{{ route('listProtocole') }}">Lister les
                            protocoles</a>
...
@section('script')
    ...
    <script src="{{ asset('/js/user/chimio/gestion_addProtocole.js') }}"></script>
