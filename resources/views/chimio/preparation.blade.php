                        ...
                        <div class="lol">
                                ...
                                <tbody>
                                    @foreach($sequences as $seq)
                                     ...
                                     <tr onclick="getinfo({{$dci}},{{$seq}},{{DB::table('cure')->where('id',$seq->cure_id)->get()}},{{DB::table('patients')
                                     ...
                                     >
                                        ...
                                        $lol=DB::table('patients')
                                            ...
                                            @endphp</td>
                                        <td>{{DB::table('sp_specialite')->where('SP_CODE_SQ_PK',$dci->pivot->medicament_id)->pluck('SP_NOM')->first()}}</td>
                                        <td>{{$dci->pivot->voie}}</td>
                                        <td>C{{DB::table('cure')->where('id',$seq->cure_id)->pluck('numero')->first()}} J{{$seq->jour}}</td>
                                        <td>{{$dci->pivot->date_debut}} &nbsp; {{$dci->pivot->heure}}</td>
                                     </tr>
                                      @endforeach
                                     @endforeach
                                 </tbody>
