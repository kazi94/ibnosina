$(
	function()
	{
           ...
           $( "form" ).on('keydown',"input[name='medicament1']",function(){
            $(this).autocomplete({
                ...
                $.ajax( {
                  ...
                  success: function( data , status , code ) {
                     ...
                     //   status = "<i "+style+">"+item.status+"</i>";
                        ...
                        return {
                            label : item.medicament+" "+dosage, // pour afficher dans la liste des suggestions
            ...
            $( "form" ).on('keydown',"input[name='medicament2']",function(){
              $(this).autocomplete({
                appendTo: $(this).parent(), // selectionner l'element pour ajouter la liste des suggestion
                source: function( request, response ) {
                  $.ajax( {
              ...
              $( "form" ).on('keydown',"input[name='medicament3']",function(){
                $(this).autocomplete({
                  appendTo: $(this).parent(), // selectionner l'element pour ajouter la liste des suggestion
                  source: function( request, response ) {
                    $.ajax( {
                ...
                $( "form" ).on('keydown',"input[name='medicament4']",function(){
                  $(this).autocomplete({
                    appendTo: $(this).parent(), // selectionner l'element pour ajouter la liste des suggestion
                    source: function( request, response ) {
                      $.ajax( {
                  ...
                  $( "form" ).on('keydown',"input[name='medicament5']",function(){
                    $(this).autocomplete({
                      appendTo: $(this).parent(), // selectionner l'element pour ajouter la liste des suggestion
                      source: function( request, response ) {
                        $.ajax( {
                    ...
                    $( "form" ).on('keydown',"input[name='medicament6']",function(){
                      $(this).autocomplete({
                        appendTo: $(this).parent(), // selectionner l'element pour ajouter la liste des suggestion
                        source: function( request, response ) {
                          $.ajax( {
