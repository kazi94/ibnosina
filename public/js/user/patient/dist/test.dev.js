  ...
  $(".up_patient").click(function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        var allergies = data['allergies']; //Map elements to select2 data struture && chech matched elements
        ...
        $("#famille_antecedants").val(patient.famille_antecedants); // Hospitalisation du patient
